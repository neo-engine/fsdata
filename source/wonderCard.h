...
struct wonderCard {
    ...
    inline wonderCard( u8 p_descriptionId, u8 p_cardId, const char* p_title, const u16 p_moves[ 4 ],
                       u16 p_pkmnId, const char* p_name, u16 p_level, u16 p_id, u16 p_sid,
                       const char* p_ot, u8 p_shiny, bool p_hiddenAbility, bool p_fatefulEncounter,
                       bool p_isEgg, u16 p_gotPlace, u8 p_female, u8 p_ball, u8 p_pokerus,
                       u8 p_forme, const u8 p_ribbons[ 12 ], const u16 p_items[ 4 ] )
